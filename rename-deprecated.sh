...
mv "$CHUNKYMAP_DEPRECATED_PATH/poikilos.py" "$CHUNKYMAP_DEST_PATH/poikilos.py"
rm "$CHUNKYMAP_DEPRECATED_PATH/poikilos.pyc"
mv "$CHUNKYMAP_DEPRECATED_PATH/poikilosregressionsuite.py" "$CHUNKYMAP_DEST_PATH/poikilosregressionsuite.py"
rm "$CHUNKYMAP_DEPRECATED_PATH/poikilosregressionsuite.pyc"
rm "$CHUNKYMAP_DEPRECATED_PATH/poikilosregressiontmp.py"
rm "$CHUNKYMAP_DEPRECATED_PATH/poikilosregressiontmp.pyc"
...
mv "$CHUNKYMAP_DEPRECATED_PATH/minetestmapper-poikilos.py" "$CHUNKYMAP_DEST_PATH/minetestmapper-poikilos.py"
