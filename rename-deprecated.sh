...
mv "$CHUNKYMAP_DEPRECATED_PATH/poikilos.py" "$CHUNKYMAP_DEST_PATH/parsing.py"
...
mv "$CHUNKYMAP_DEPRECATED_PATH/minetestmapper-poikilos.py" "$CHUNKYMAP_DEST_PATH/minetestmapper.py"
